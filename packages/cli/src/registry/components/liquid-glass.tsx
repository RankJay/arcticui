...
export const LiquidGlass = React.forwardRef<HTMLDivElement, LiquidGlassProps>(
  (
    ...
    }, [surface, bezelWidth, glassThickness, scaleRatio, chromaticStrength]);
    ...
    return (
      <>
        ...
        <div
          ...
          {...props}
        >
          {/* 1. Edge darkening (ambient occlusion) */}
          <div
            aria-hidden="true"
            style={{
              position: "absolute",
          ...
          />
          {/* 2. Environment reflection - layered for structure and variation */}
          <div
            aria-hidden="true"
            style={{
              position: "absolute",
              inset: 0,
              background: [
                "linear-gradient(140deg, rgba(255,255,255,0.015) 0%, rgba(255,255,255,0.004) 22%, transparent 42%)",
                "linear-gradient(200deg, transparent 50%, rgba(0,0,0,0.006) 85%, rgba(0,0,0,0.003) 100%)",
                "linear-gradient(70deg, transparent 55%, rgba(255,255,255,0.006) 75%, transparent 95%)",
                "radial-gradient(ellipse 70% 50% at 20% 30%, rgba(255,255,255,0.008) 0%, transparent 45%)",
              ].join(", "),
              pointerEvents: "none",
              borderRadius: "inherit",
            }}
          />
          {/* 3. Fresnel - edge reflection */}
          <div
            aria-hidden="true"
            style={{
              position: "absolute",
          ...
          <div
            ...
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse 70% 50% at 25% 25%, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.08) 35%, transparent 70%)",
              pointerEvents: "none",
              borderRadius: "inherit",
            }}
          />
