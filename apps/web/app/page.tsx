      ...
      <div className="flex flex-col items-center justify-center h-auto w-full gap-56 max-md:gap-10 pb-10">
        ...
        <div className="flex w-full px-40 h-auto gap-20 max-lg:flex-col max-md:px-12">
          <div className="flex flex-col gap-2">
            ...
            <ComponentDescription>
              An interactive animated orb component that responds to audio input,
              creating a mesmerizing visual experience. Features real-time audio
              pitch detection and smooth gradient animations powered by mesh
              gradients.
            </ComponentDescription>
            <div className="flex gap-2 mt-2">
              <ComponentTag>react</ComponentTag>
